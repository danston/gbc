...
namespace gbc {
    ...
    public:
        ...
        // The number of returned coordinates is the number of the polygon's vertices + the number
        // of the points p. All the coordinates are ordered as _v[0].b(), ..., _v[n-1].b(), p[0].b(), ..., p[N-1].b(),
        // where n = _v.size() and N = p.size().
        ...
        // The number of returned coordinates is the number of the polygon's vertices + the number
        // of the points p generated by the TriangulatorR2.hpp. All the coordinates are ordered as 
